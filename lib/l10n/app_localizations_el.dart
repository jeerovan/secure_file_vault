...
class AppLocalizationsEl extends AppLocalizations {
  ...
  String get notificationPermissionPageDescription =>
      'Για γρήγορο συγχρονισμό και μεταφόρτωση των αρχείων σας στο παρασκήνιο μέσω του πίνακα ειδοποιήσεων, χρειαζόμαστε άδεια για την εμφάνιση ειδοποιήσεων. Μπορείτε να την απενεργοποιήσετε οποιαδήποτε στιγμή από τις ρυθμίσεις.';
  ...
  String get notificationPermissionSettingsDescription =>
      'Οι ειδοποιήσεις είναι απαραίτητες για τη γρήγορη λειτουργία συγχρονισμού μέσω του πίνακα ειδοποιήσεων. Ενεργοποιήστε τις από τις ρυθμίσεις του συστήματος, ώστε να διασφαλιστεί ότι όλα τα δεδομένα σας θα μεταφορτωθούν.';
